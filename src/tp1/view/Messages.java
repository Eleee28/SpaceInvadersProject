...
public class Messages {
	...
	public static final String POINTS_SL_ERROR = "Not enough points: only %d points, %d points required";	// Our code

	public static final String SL_IN_BOARD = "Super laser is already in the board, change text! hehe"; // maybe super laser in flight?? 
	
	public static final String L_IN_BOARD = "Laser is already in the board, change text! hehe"; // maybe super laser in flight?? 

	public static final String OFF_BOARD_ERROR = "Cannot move in direction %s from position (%d, %d)";
	
	public static final String ALLOWED_SHIP_MOVE = "Allowed UCMShip moves: <left|lleft|right|rright>";
	
	public static final String INVALID_RESET_CONF = "Invalid reset configuration";
	...
	public static final String COMMAND_RESET_HELP = "resets the game using the initial configuration in file <filename>";
	...
	public static final String COMMAND_SUPER_LASER_NAME = "shoot super laser";
	...
	// My code
	public static final String errorPointsDisplay(int myPoints, int required) {
		return Messages.POINTS_SL_ERROR.formatted(myPoints, required);
	}
	
	public static final String errorOffBoard(String move, int row, int col) {
		return Messages.OFF_BOARD_ERROR.formatted(move, row, col);
	}
